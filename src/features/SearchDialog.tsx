...
export function SearchDialog({ open, onClose, onLoad }: SearchDialogProps) {
  ...
  return <dialog ref={dialog} className="search-dialog" onCancel={onClose} onClose={onClose} aria-labelledby="search-title"
    onKeyDown={(event) => {
