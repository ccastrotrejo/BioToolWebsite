...
export function LibraryPanel({ saved, currentId, open, onLoad, onLoadSaved, onRemove, onImport, onClear }: LibraryPanelProps) {
  ...
  return <aside className="library-panel" id="library-panel" data-open={open} aria-labelledby="library-heading" tabIndex={0}>
